    ...
    peer = new Peer(peerId, {
      ...
      config: {
        iceServers: [
          ...
          // STUN alone only works when both peers are on fairly open networks.
          // Without a TURN relay fallback, calls between people on stricter
          // NATs (mobile data, many home routers, school/work networks)
          // never connect at all — no audio, video, screen share, or data.
          // Open Relay Project provides a free public TURN server for this.
